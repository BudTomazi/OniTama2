# -*- coding: utf-8 -*-
"""
Created on Tue Feb 16 21:49:09 2021
...
class network():
    def __init__(self, alpha, hidden_size):
        ...
        # self.weights_1_2 = 2 * np.random.random((hidden_size,150)) - 1
        # self.weights_2_3 = 2 * np.random.random((150,1)) - 1
        self.weights_0_1 = np.load("01weights.npy")
        self.weights_1_2 = np.load("12weights.npy")
        self.weights_2_3 = np.load("23weights.npy")
        self.temperature = 10
    ...
    def train(self):
        for i in range(self.temperature):
            ...
            for j in range(len(self.inputs)):
                ...
                layer_3_error += np.sum((layer_3 - self.outputs[j:j+1]) ** 2)
                
                layer_3_delta = self.outputs[j:j+1] - layer_3
                ...
                self.weights_2_3 += self.alpha * layer_2.T.dot(layer_3_delta)
